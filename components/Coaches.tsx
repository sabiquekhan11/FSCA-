            ...
            <div className="container">
                ...
                <div className="about-grid">
                    ...
                    <div className="coach-details">
                        ...
                        <p className="coach-role" style={{ color: 'var(--text-main)', fontFamily: 'var(--font-heading)', fontSize: '1.25rem', textTransform: 'uppercase', marginBottom: '1.5rem', letterSpacing: '1px' }}>Head Coach & Founder (NIS Certified, Ex-Ranji Trophy)</p>
                        ...
                        <ul className="credentials-list" style={{ marginTop: '1.5rem' }}>
                            ...
                            <li><span className="check-icon">✓</span> Specialized in All Age Groups Competitive Training</li>

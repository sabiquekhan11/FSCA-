        ...
        <section id="about" className="section about-section">
            <div className="container about-grid">
                <div className="about-content">
                    ...
                    <p className="about-text">Future Star Cricket Academy provides premier coaching facilities in Mirzapur. Founded by Ex-Ranji Trophy player Satish Patnaik, we focus on identifying and nurturing youth talent, preparing them for highly competitive U-17 and district-level tournaments.</p>
                    <ul className="credentials-list">
                        <li><span className="check-icon">✓</span> Head Coach: Satish Patnaik (Ex-Ranji Trophy)</li>
                        <li><span className="check-icon">✓</span> Specialized U-17 competitive training programs</li>
